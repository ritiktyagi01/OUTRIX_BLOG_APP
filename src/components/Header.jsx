    ...
    return (
        <div className='relative mx-8 sm:mx-16 xl:mx-24 '>
            <div className='text-center mt-20 mb-8'>
                <div className='inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm text-primary h-7 w-65'>
            ...
            <img src={assets.gradientBackground} alt="" className='absolute -top-50 -z-1 opacity-75' />
        </div>
    )
}
